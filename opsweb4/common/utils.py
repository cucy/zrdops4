class PageLinksMixin:
    ...
    def page_range(self, page):
        if page.number > 1:
            ...
            start = page_number - self.before_range_num if page_number - self.before_range_num > 0 else 0
            page['page_range'] = page_range[start:page_number + self.after_range_num]
        return None
